        ...
        <div className='bg-[#F9FAFC]'>
            <div className='container mx-auto py-30 px-0 md:px-30'>
                ...
                <div className='flex gap-6 items-center justify-center flex-col lg:flex-row'>
                    ...
                    <div className="card bg-base-100 px-6 py-20 shadow-sm">
                        <div className="size-9 rounded-full bg-radial-[at_50%_75%] from-[#4F39F6] to-[#4F39F6] to-90% text-white absolute left-80 top-10 flex items-center justify-center">02</div>
                        <figure className="px-10 pt-10">
                            <img src={Package} />
                        </figure>
                        <div className="card-body items-center text-center">
                    ...
                    <div className="card bg-base-100 px-6 py-20 shadow-sm">
                        <div className="size-9 rounded-full bg-radial-[at_50%_75%] from-[#4F39F6] to-[#4F39F6] to-90% text-white absolute left-80 top-10 flex items-center justify-center">03</div>
                        <figure className="px-10 pt-10">
                            <img src={rocket} />
                        </figure>
                        <div className="card-body items-center text-center">
